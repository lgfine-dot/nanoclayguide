...
<!--
FLAG FOR REVIEW: BET values for Na-MMT (250–400) represent purified grades. Lower-purity commercial products may report 30–80 m²/g. Halloysite BET of 50–70 m²/g is typical for Dragonite/PATCH products; some literature reports up to 100 m²/g for acid-etched grades. Verify against your supplier data. Sepiolite BET range is broad — Pangel grades (Tolsa) may differ from generic. Kaolinite CEC of 1–5 meq/100g is for well-crystallized grades; disordered kaolinites can reach 10–15 meq/100g.
-->
...
<!--
FLAG FOR REVIEW: Applied Minerals Inc. went through financial difficulties and corporate changes. Verify the current commercial status of the Dragonite deposit and whether I-Minerals is the correct current entity. Other halloysite sources include Northland (NZ) and various Chinese suppliers. The New Zealand deposit (IMERYS) may be the primary source now.
-->
...
- **[What Is Nanoclay?](/blog/what-is-nanoclay/)** — The practical definition for engineers and buyers
- **[QC & Procurement](/pillars/qc-procurement/)** — How to specify, test, and qualify the nanoclay type you've selected
- **[Applications](/pillars/applications/)** — Detailed application guides by end-use sector
